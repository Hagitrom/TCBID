...
-- 2.ADD FK
	...
	-- 1
			--TABLE 3  - DOESN'T WORK
	
--ALTER TABLE Addresses_RelativesEmployees
--ADD FOREIGN KEY (ID) REFERENCES EMPLOYEES(ID)

--ALTER TABLE Addresses_RelativesEmployees
--ADD FOREIGN KEY (ID) REFERENCES RelativesEmployees (ID)

--ALTER TABLE [dbo].[Addresses_RelativesEmployees]  
--WITH CHECK ADD  CONSTRAINT [FK_Addresses_RelativesEmployees_RelativesEmployees] 
--FOREIGN KEY([ID])
--REFERENCES [dbo].[RelativesEmployees] ([ID])

--ALTER TABLE [dbo].[Employees]  WITH CHECK ADD  
--CONSTRAINT [FK_Employees_RelativesEmployees] 
--FOREIGN KEY([ID])
--REFERENCES [dbo].[RelativesEmployees] ([ID])
--GO
	...
	ALTER TABLE													EmploymentCost
	ADD FOREIGN KEY		(EmployeeID)		REFERENCES			Employees(EmployeeID)
--- CANT ADD THIS:There are no primary or candidate keys in the referenced table 'Employees' that match the referencing column list in the foreign key 'FK__Employmen__Salar__6754599E'.
	--ALTER TABLE												EmploymentCost
	--add FOREIGN KEY	(SalaryCurrentBasic)REFERENCES	Employees(SalaryCurrentBasic)
 --3 ADD Constraints
...
----Table 8 - ProjectEmployees  - cant add employees to a project classified under his team
TBD
